...
public class AccountService {
    ...
    public void editUser(String email, String newEmail, String newPassword, String newFirstName, String newLastName) throws Exception {
        UserDB userDB = new UserDB();
        User user = userDB.getUser(email);
    ...
    public void editUsers(String email, String newEmail, boolean active, String newPassword, String newFirstName, String newLastName, int intRole) throws Exception {
        UserDB userDB = new UserDB();
        String roleName = "";
        User user = userDB.getUser(email);
        user.setEmail(newEmail);
